...
def run_text_api_processing():
    """Run integration test for text_api_processing"""
    try:
        ...
        with patch('boto3.client') as mock_boto_client:
            ...
            event_data = {"body":"{\"customerId\":\"CUST-00001\",\"rating\":5,\"feedback\":\"Excellent service and very helpful staff! The product quality exceeded my expectations.\",\"timestamp\":\"2023-12-09T14:00:00.000Z\"}","httpMethod":"POST","headers":{"Content-Type":"application/json"}}
            
            if 'text_api_processing' in ['text_processing_pipeline', 'text_api_processing']:
                ...
                if 'text_api_processing' == 'text_processing_pipeline':
                    context = Mock()
                ...
                elif 'text_api_processing' == 'text_api_processing':
                    context = Mock()
                    context.aws_request_id = 'test-request-id'
                    result = text_handler(event_data, context)
            ...
            elif 'text_api_processing' in ['image_processing_pipeline', 'image_raw_processing']:
            ...
            elif 'text_api_processing' == 'audio_processing_pipeline':
            ...
            elif 'text_api_processing' in ['metadata_preservation', 'quality_score_consistency', 'error_handling', 'dlq_functionality']:
                # Generic test for cross-component functionality
                print(f"✅ text_api_processing test passed")
                return True
...
if __name__ == '__main__':
    success = run_text_api_processing()
