...
def run_metadata_preservation():
    """Run integration test for metadata_preservation"""
    try:
        ...
        with patch('boto3.client') as mock_boto_client:
            ...
            if 'metadata_preservation' in ['text_processing_pipeline', 'text_api_processing']:
                ...
                if 'metadata_preservation' == 'text_processing_pipeline':
                    context = Mock()
                ...
                elif 'metadata_preservation' == 'text_api_processing':
                    context = Mock()
                    context.aws_request_id = 'test-request-id'
                    result = text_handler(event_data, context)
            ...
            elif 'metadata_preservation' in ['image_processing_pipeline', 'image_raw_processing']:
            ...
            elif 'metadata_preservation' == 'audio_processing_pipeline':
            ...
            elif 'metadata_preservation' in ['metadata_preservation', 'quality_score_consistency', 'error_handling', 'dlq_functionality']:
                # Generic test for cross-component functionality
                print(f"✅ metadata_preservation test passed")
                return True
...
if __name__ == '__main__':
    success = run_metadata_preservation()
