...
def run_error_handling():
    """Run integration test for error_handling"""
    try:
        ...
        with patch('boto3.client') as mock_boto_client:
            ...
            event_data = {"Records":[{"eventVersion":"2.1","eventSource":"aws:s3","s3":{"bucket":{"name":"forbidden-bucket"},"object":{"key":"restricted/file.txt"}}}]}
            
            if 'error_handling' in ['text_processing_pipeline', 'text_api_processing']:
                ...
                if 'error_handling' == 'text_processing_pipeline':
                    context = Mock()
                ...
                elif 'error_handling' == 'text_api_processing':
                    context = Mock()
                    context.aws_request_id = 'test-request-id'
                    result = text_handler(event_data, context)
            ...
            elif 'error_handling' in ['image_processing_pipeline', 'image_raw_processing']:
            ...
            elif 'error_handling' == 'audio_processing_pipeline':
            ...
            elif 'error_handling' in ['metadata_preservation', 'quality_score_consistency', 'error_handling', 'dlq_functionality']:
                # Generic test for cross-component functionality
                print(f"✅ error_handling test passed")
                return True
